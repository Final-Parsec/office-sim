...
{     
	public static BreadCrumb FindPath(Pathfinding world, Point start, Point end)
	{        
	...
	private static BreadCrumb FindPathReversed(Pathfinding world, Point start, Point end)
	{
